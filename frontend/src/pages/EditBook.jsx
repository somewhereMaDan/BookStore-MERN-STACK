...
const EditBook = () => {
  ...
  const handleEditBook = () => {
    // it'll get here, by getting the values what user changed in the input fields
    const data = {
      title,
      author,
      publishYear,
      // storing the changed values in a JSON
    };
    ...
    <div className='p-4'>
      ...
      <div className='flex flex-col border-2 border-sky-400 rounded-xl w-[600px] p-4 mx-auto'>
        ...
        <button className='p-2 bg-sky-300 m-8' onClick={handleEditBook}>
          {/* and when usesr click click the btn after making changes */}
          Save
        </button>
      </div>
    </div>
